...
class edit_userproductsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        contextt = this@edit_userproductsActivity
        ...
        val context = this@edit_userproductsActivity
        ...
        spinnerModel.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                Toast.makeText(this@edit_userproductsActivity, "selectedItem: $selectedItem", Toast.LENGTH_SHORT).show()
                model = "$selectedItem"
            }
        ...
        btnAdd!!.setOnClickListener {
            APIService.ProductService.update(
                ...
                .enqueue(object : Callback<produitService.updateProduct> {
                    override fun onResponse(
                        call: Call<produitService.updateProduct>,
                        response: Response<produitService.addProduct>
                    ) {
                    ...
                    override fun onFailure(call: Call<produitService.addProduct>, t: Throwable) {
                        println("HTTP ERROR")
                        t.printStackTrace()
                    }
                })
